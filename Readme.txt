...
== Changelog ==
v 1.7.7.3 -
* [Fix] - Instant Settle with Setting skip order lines make calculate amount double.
* [Fix] - WooCommerce discount coupons don't work on mixed orders with Billwerk+ Optimize
