	...
	public function init_form_fields() {
		$this->form_fields = array(
			...
			'settle'             => array(
				...
				'css'            => 'height: 150px',
				'options'        => array(
					WC_Reepay_Instant_Settle::SETTLE_VIRTUAL   => __( 'Instant Settle online / virtualproducts', 'woocommerce-gateway-reepay-checkout' ),
					WC_Reepay_Instant_Settle::SETTLE_PHYSICAL  => __( 'Instant Settle physical  products', 'woocommerce-gateway-reepay-checkout' ),
					WC_Reepay_Instant_Settle::SETTLE_RECURRING => __( 'Instant Settle recurring (subscription) products', 'woocommerce-gateway-reepay-checkout' ),
					WC_Reepay_Instant_Settle::SETTLE_FEE       => __( 'Instant Settle fees', 'woocommerce-gateway-reepay-checkout' ),
				),
				'select_buttons' => true,
				'default'     => $this->settle
			),
