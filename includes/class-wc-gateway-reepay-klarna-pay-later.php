...
class WC_Gateway_Reepay_Klarna_Pay_Later extends WC_Gateway_Reepay {
	...
	public function __construct() {
		...
		$this->method_title = __( 'Reepay - Klarna Pay Later', 'woocommerce-gateway-reepay-checkout' );
		...
		$this->logos        = array( 'klarna-pay-later' );
	...
	public function init_form_fields() {
		$this->form_fields = array(
			...
			'title'          => array(
				...
				'default'     => __( 'Reepay - Klarna Pay Later', 'woocommerce-gateway-reepay-checkout' )
			),
			'description'    => array(
