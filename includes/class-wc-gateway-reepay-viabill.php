...
class WC_Gateway_Reepay_Viabill extends WC_Gateway_Reepay {
	...
	public function __construct() {
		...
		$this->method_title = __( 'Reepay - ViaBill', 'woocommerce-gateway-reepay-checkout' );
		//$this->icon         = apply_filters( 'woocommerce_reepay_viabill_icon', plugins_url( '/assets/images/viabill.png', dirname( __FILE__ ) ) );
		$this->supports     = array(
			'products',
			'refunds',
		);
	...
	public function init_form_fields() {
		$this->form_fields = array(
			...
			'title'          => array(
				...
				'default'     => __( 'Reepay - ViaBill', 'woocommerce-gateway-reepay-checkout' )
			),
			'description'    => array(
...
// Register Gateway
WC_ReepayCheckout::register_gateway( 'WC_Gateway_Reepay_Viabill' );
