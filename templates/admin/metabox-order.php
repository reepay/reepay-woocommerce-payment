...
<ul class="order_action">
    ...
    <li class="reepay-admin-section-li">
        ...
        <span class="reepay-balance__amount">
            ...
            <?php echo rp_make_initial_amount($order_data['authorized_amount'] - $order_data['settled_amount'], $order_data['currency']) . ' ' . get_woocommerce_currency_symbol(); ?>
        </span>
    </li>
    <li class="reepay-admin-section-li">
        <span class="reepay-balance__label">
    ...
    <input id="reepay_order_total" type="hidden"
           value="<?php echo rp_make_initial_amount($amount_to_capture, $order_data['currency']) . ' ' . $order_data['currency']; ?>"
           data-order-total="<?php echo rp_make_initial_amount($amount_to_capture, $order_data['currency']); ?>">
