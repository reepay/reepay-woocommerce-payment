...
class SubscriptionsTest extends WP_UnitTestCase {
	...
	public function test_wcs_is_subscription_product() {
		...
		$this->assertFalse( wcs_is_subscription_product( $product_generator->generate( 'simple' ) ) );
		$this->assertFalse( wcs_is_subscription_product( $product_generator->generate( 'variable' ) ) );

		if( RP_TEST_PLUGINS_STATE::woo_subs_activated() ) {
			$this->assertTrue( wcs_is_subscription_product( $product_generator->generate( 'woo_sub' ) ) );
		}

		if( RP_TEST_PLUGINS_STATE::rp_subs_activated() ) {
			$this->assertFalse( wcs_is_subscription_product( $product_generator->generate( 'rp_sub' ) ) );
		}
	...
	public function test_wcr_is_subscription_product() {
		...
		$this->assertFalse( wcr_is_subscription_product( $product_generator->generate( 'simple' ) ) );
		$this->assertFalse( wcr_is_subscription_product( $product_generator->generate( 'variable' ) ) );

		if( RP_TEST_PLUGINS_STATE::woo_subs_activated() ) {
			$this->assertFalse( wcs_is_subscription_product( $product_generator->generate( 'woo_sub' ) ) );
		}

		if( RP_TEST_PLUGINS_STATE::rp_subs_activated() ) {
			$this->assertTrue( wcs_is_subscription_product( $product_generator->generate( 'rp_sub' ) ) );
		}
	...
	public function test_wcs_is_payment_change( bool $test_val, bool $result ) {
		if ( ! RP_TEST_PLUGINS_STATE::woo_subs_activated() ) {
			$this->markTestSkipped( 'Woocommerce subscription not activated' );
		}
	...
	public function test_wcs_cart_have_subscription() {
		...
		$this->assertFalse( wcs_cart_have_subscription() );

		$cart_generator->new_cart( 'variable' );
		$this->assertFalse( wcs_cart_have_subscription() );

		if( RP_TEST_PLUGINS_STATE::woo_subs_activated() ) {
			$cart_generator->new_cart( 'woo_sub' );
			$this->assertTrue( wcs_cart_have_subscription() );
		}
	...
	public function test_wcs_cart_only_subscriptions() {
		...
		$cart_generator->new_cart( 'simple' );
		$this->assertFalse( wcs_cart_only_subscriptions() );
		...
		if( RP_TEST_PLUGINS_STATE::woo_subs_activated() ) {
			...
			$this->assertTrue( wcs_cart_only_subscriptions() );
		}
	...
	public function test_wc_cart_only_reepay_subscriptions() {
		...
		$cart_generator->new_cart( 'simple' );
		$this->assertFalse( wc_cart_only_reepay_subscriptions() );
		...
		if( RP_TEST_PLUGINS_STATE::rp_subs_activated() ) {
			...
			$cart_generator->new_cart( array( 'rp_sub', 'rp_sub' ) );
			$this->assertTrue( wc_cart_only_reepay_subscriptions() );
		}
